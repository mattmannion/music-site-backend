...
const createConfUrl_1 = require("../utils/createConfUrl");
let RegisterResolver = class RegisterResolver {
    ...
    register({ email, firstName, lastName, password }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield sendEmail_1.sendEmail(email, yield createConfUrl_1.createConfUrl(user.id)).then(() => console.log('email sent'));
            return user;
        });
    }
};
