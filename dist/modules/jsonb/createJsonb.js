...
exports.CreateJsonResolver = void 0;
const type_graphql_1 = require("type-graphql");
const jsonbtest_1 = require("../../entity/jsonbtest");
const createJsonInput_1 = require("./jsonbInputs/createJsonInput");
const uuid_1 = require("uuid");
let CreateJsonResolver = class CreateJsonResolver {
    createJson({ name, options }) {
        return __awaiter(this, void 0, void 0, function* () {
            const id = uuid_1.v4().replace(/-/g, '');
...
__decorate([
    ...
    __metadata("design:paramtypes", [createJsonInput_1.Input]),
    __metadata("design:returntype", Promise)
], CreateJsonResolver.prototype, "createJson", null);
CreateJsonResolver = __decorate([
    type_graphql_1.Resolver()
], CreateJsonResolver);
exports.CreateJsonResolver = CreateJsonResolver;
